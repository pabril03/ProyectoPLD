...
@onready var spawn_points = [
	$"Spawns-PowerUp/Marker2D6",
	$"Spawns-PowerUp/Marker2D7",
	$"Spawns-PowerUp/Marker2D8",
	$"Spawns-PowerUp/Marker2D4"
]
...
@onready var spawn_shotgun = [
	$"Spawns-shotgun/Marker2D11",
	$"Spawns-shotgun/Marker2D12"
]

@onready var spawn_sniper = [
	$"Spawns-sniper/Marker2D8",
	$"Spawns-sniper/Marker2D9",
	$"Spawns-sniper/Marker2D10",
	$"Spawns-sniper/Marker2D11"
]

@onready var spawn_polimorf = [
	$"Spawns-polimorf/Marker2D3",
	$"Spawns-polimorf/Marker2D5"
]
...
@onready var spawn_launcher = [
	$"Spawns-launcher/Marker2D5"
]

@onready var spawn_minigun = [
	$"Spawns-minigun/Marker2D",
	$"Spawns-minigun/Marker2D2"
]

@onready var trap_points := [
	$"Spawns-fire-traps/Marker2D11",
	$"Spawns-fire-traps/Marker2D12",
	$"Spawns-fire-traps/Marker2D13",
	$"Spawns-fire-traps/Marker2D14",
	$"Spawns-fire-traps/Marker2D15",
	$"Spawns-fire-traps/Marker2D16",
	$"Spawns-fire-traps/Marker2D17",
	$"Spawns-fire-traps/Marker2D18",
]
